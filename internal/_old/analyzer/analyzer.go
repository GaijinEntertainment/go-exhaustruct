...
import (
	...
	comment2 "dev.gaijin.team/go/go-exhaustruct/v4/internal/_old/comment"
	"dev.gaijin.team/go/go-exhaustruct/v4/internal/_old/pattern"
	structure2 "dev.gaijin.team/go/go-exhaustruct/v4/internal/_old/structure"
)
...
type analyzer struct {
	...
	structFields structure2.FieldsCache `exhaustruct:"optional"`
	comments     comment2.Cache         `exhaustruct:"optional"`
...
func (a *analyzer) processStruct(
	...
	if shouldProcess && comment2.HasDirective(comments, comment2.DirectiveIgnore) {
		return nil, ""
	}

	if !shouldProcess && !comment2.HasDirective(comments, comment2.DirectiveEnforce) {
		return nil, ""
	}
